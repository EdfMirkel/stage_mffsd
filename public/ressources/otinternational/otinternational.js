/*! jlUIkit 3.4.0 | https://www.getuikit.com | (c) 2014 - 2020 YOOtheme | MIT License */

!function (t, e) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define("uikit", e) : (t = t || self).jlUIkit = e()
}(this, function () {
    "use strict";
    ...
    function St(t, s, e) {
        if (void 0 === s && (s = document),
            ...
            return null;
        var a;
        At(t = t.replace(Et, "$1 *")) && (a = [],
            t = t.match(Ct).map(function (t) {
                ...
                if ("-" === t[0]) {
                    ...
                    i = Nt(o, t.substr(1)) ? o : null,
                        t = r.slice(1).join(" ")
                }
                return i ? (i.id || (i.id = "jl-" + Date.now() + e,
                    a.push(function () {
                        return at(i, "id")
                    })),
                    "#" + Ot(i.id) + " " + t) : null
    ...
    function Dt(t, e) {
        return w(e, ">") && (e = e.slice(1)),
            M(t) ? zt.call(t, e) : V(t).map(function (t) {
                return Dt(t, e)
            }).filter(Boolean)
    }
    function Bt(t) {
    ...
    function Yt() {
        for (var t = [], e = arguments.length; e--;)
            t[e] = arguments[e];
        var i, n, r = Zt(t), o = r[0], s = r[1], a = r[2], h = r[3], u = r[4];
        return o = ie(o),
            1 < h.length && (i = h,
                h = function (t) {
    ...
    function me(t, e, i, n) {
        void 0 === i && (i = 0),
            void 0 === n && (n = !1);
        var r = (e = V(e)).length;
        return t = P(t) ? F(t) : "next" === t ? i + 1 : "previous" === t ? i - 1 : pe(e, t),
            n ? tt(t, 0, r - 1) : (t %= r) < 0 ? t + r : t
    }
    function ge(t) {
        return (t = _e(t)).innerHTML = "",
            t
    }
    function ve(t, e) {
        return t = _e(t),
    ...
    function Ye(t) {
        ...
        if (!ut)
            return Re(e).getPropertyValue("--jl-" + t);
        if (!(t in Ue)) {
            var i = we(e, document.createElement("div"));
            ze(i, "jl-" + t),
                Ue[t] = qe(i, "content", ":before").replace(/^["'](.*)["']$/, "$1"),
                ke(i)
        }
        return Ue[t]
    }
    ...
    var Ze = {
        ...
        inProgress: function (t) {
            return Oe(t, "jl-transition")
        }
    }
        , Qe = "jl-animation-"
        , ti = "jl-cancel-animation";
            ...
            se.all(V(t).map(function (s) {
                return new se(function (n, r) {
                    if (Oe(s, ti))
                        ...
                        w(e, Qe) && (a && (t += " jl-transform-origin-" + a),
                            h && (t += " " + Qe + "reverse")),
                            o(),
    ...
    function ai(t) {
        ...
        Ft(t) || "none" !== Ve(t, "display") || (e = ot(t, "style"),
            i = ot(t, "hidden"),
            ot(t, {
    ...
    function Ri(t) {
        return !(!w(t, "jl-") && !w(t, "data-jl-")) && f(t.replace("data-jl-", "").replace("jl-", ""))
    }
    function qi(t) {
        this._init(t)
    }
    ...
    qi.util = Object.freeze({
        ...
        Ui.extend = function (t) {
            ...
            return ((e.prototype = Object.create(this.prototype)).constructor = e).options = _i(this.options, t),
                e.super = this,
            ...
            methods: {
                toggleElement: function (u, c, l) {
                    ...
                    return new se(function (t) {
                        ...
                        var i;
                        if (!d.queued || !H(c) || !d.hasAnimation || u.length < 2)
                            i = e(u);
                        else {
                            var n = u.filter(function (t) {
                                ...
                                , s = o.scrollTop
                                , a = n[0]
                                , h = ni.inProgress(a) && Oe(a, "jl-animation-leave") || Ze.inProgress(a) && "0px" === a.style.height;
                            i = e(n),
                                h || (i = i.then(function () {
                                    var t = e(r);
                ...
                _toggleElement: function (t, e, i) {
                    var n = this;
                    if (e = z(e) ? e : ni.inProgress(t) ? Oe(t, "jl-animation-leave") : Ze.inProgress(t) ? "0px" === t.style.height : !this.isToggled(t),
                        !Kt(t, "before" + (e ? "show" : "hide"), [this]))
                        return se.reject();
                    var o, r = ($(i) ? i : !1 !== i && this.hasAnimation ? this.hasTransition ? cn(this) : (o = this,
                        function (t, e) {
                            ni.cancel(t);
                            var i = o.animation
                                , n = o.duration
    ...
    var ln = {
        ...
        data: {
            ...
            multiple: !1,
            clsOpen: "jl-open",
            toggle: "> .jl-accordion-title",
            content: "> .jl-accordion-content",
            transition: "ease",
            offset: 0
        },
        computed: {
        ...
        events: [{
            ...
            handler: function (t) {
                t.preventDefault(),
                    this.toggle(pe(Me(this.targets + " " + this.$props.toggle, this.$el), t.current))
            }
        }],
        methods: {
            toggle: function (t, r) {
                ...
                this.multiple || b(i, e[0]) || (e = e.concat(i)),
                    (this.collapsible || Vt(e, ":not(." + this.clsOpen + ")").length) && e.forEach(function (t) {
                        return o.toggleElement(t, !Oe(t, o.clsOpen), function (e, i) {
                            He(e, o.clsOpen, i);
                            var n = _e((e._wrapper ? "> * " : "") + o.content, e);
                            if (!1 !== r && o.hasTransition)
                                return e._wrapper || (e._wrapper = $e(n, "<div" + (i ? " hidden" : "") + ">")),
                                    dn(n, !1),
    ...
    var gn, vn = {
        ...
        computed: {
            ...
            clsDrop: function (t) {
                return t.clsDrop || "jl-" + this.$options.name
            },
            clsPos: function () {
                return this.clsDrop
            }
        ...
        events: [{
            ...
            handler: function () {
                ...
                (gn = this).tracker.init(),
                    ...
                    Gt(this.$el, "hide", Yt(document, pt, function (t) {
                        var r = t.target;
            ...
            handler: function (t) {
                var e = t.target;
                this.$el === e ? (gn = this.isActive() ? null : gn,
                    Kt(this.$el, "updatearia"),
                    this.tracker.cancel()) : gn = null === gn && Rt(e, this.$el) && this.isToggled() ? this : gn
            }
        }, {
            name: "updatearia",
            self: !0,
        ...
        methods: {
            ...
            position: function () {
                Be(this.$el, this.clsDrop + "-(stack|boundary)"),
    ...
    var bn = {
        ...
        update: function () {
            var t = this.target
                , e = this.input;
            if (t) {
                var i, n = Wt(t) ? "value" : "textContent", r = t[n], o = e.files && e.files[0] ? e.files[0].name : Nt(e, "select") && (i = Me("option", e).filter(function (t) {
                    return t.selected
        ...
        , yn = {
            ...
            data: {
                margin: "jl-margin-small-top",
                firstColumn: "jl-first-column"
            },
            update: {
                read: function () {
                    return {
    ...
    var In = {
        ...
        data: {
            margin: "jl-grid-margin",
            clsStack: "jl-grid-stack",
            masonry: !1,
            parallax: 0
        },
        computed: {
        ...
        connected: function () {
            this.masonry && ze(this.$el, "jl-flex-top jl-flex-wrap-top")
        },
        update: [{
            read: function (t) {
                return {
            ...
            read: function (t) {
                ...
                if (this.masonry && this.length) {
                    ...
                    h = r.reduce(function (i, t, n) {
                        ...
                        s = r,
                        u = Math.max.apply(Math, s.reduce(function (i, t) {
                            return t.forEach(function (t, e) {
        ...
        update: {
            read: function (t) {
                ...
                if (this.expand) {
                    ...
                    !0 === this.offsetBottom ? i += " - " + _n(this.$el.nextElementSibling) + "px" : P(this.offsetBottom) ? i += " - " + this.offsetBottom + "vh" : this.offsetBottom && u(this.offsetBottom, "px") ? i += " - " + j(this.offsetBottom) + "px" : D(this.offsetBottom) && (i += " - " + _n(xt(this.offsetBottom, this.$el)) + "px"),
                        i += (n ? " - " + n + "px" : "") + ")"
                }
                return {
                    minHeight: i,
    ...
    var Mn = {
        ...
        update: {
            ...
            write: function () {
                var t, e;
                t = this.svgEl,
                    (e = Bn(t)) && t.style.setProperty("--jl-animation-stroke", e)
            },
            type: ["resize"]
        },
        methods: {
    ...
    var On = {}
            ...
            methods: {
                getSvg: function () {
                    var t, e = function (t) {
                        ...
                        ct ? X(X(t, "left", "right"), "previous", "next") : t));
        ...
        , jn = {
            extends: Fn,
            beforeConnect: function () {
                ze(this.$el, "jl-slidenav")
            },
            computed: {
                icon: function (t, e) {
                    var i = t.icon;
                    return Oe(e, "jl-slidenav-large") ? i + "-large" : i
                }
            }
        }
        , Wn = {
            ...
            computed: {
                icon: function (t, e) {
                    var i = t.icon;
                    return Oe(e, "jl-search-icon") && qt(e, ".jl-search-large").length ? "search-large" : qt(e, ".jl-search-navbar").length ? "search-navbar" : i
                }
            }
        }
        , Vn = {
            ...
            computed: {
                icon: function () {
                    return "close-" + (Oe(this.$el, "jl-close-large") ? "large" : "icon")
                }
            }
        }
        , Rn = {
        ...
        methods: {
            load: function (t) {
                ...
                t.some(function (t) {
                    ...
                    return Un(e.$el, Qn(t), t.srcset, t.sizes),
                        tr[e.cacheKey] = Qn(t),
                        t
                }, et),
                    this.observer.disconnect())
    ...
    function Un(t, e, i, n) {
        if (Zn(t))
            ...
            !b(t.style.backgroundImage, e) && (Ve(t, "backgroundImage", "url(" + Ot(e) + ")"),
                Kt(t, Jt("load", !1)))
        }
    }
    ...
    var nr = {
        ...
        data: {
            fill: "",
            clsWrapper: "jl-leader-fill",
            clsHide: "jl-leader-hide",
            attrFill: "data-fill"
        },
        computed: {
            fill: function (t) {
            ...
            events: [{
                ...
                handler: function (t) {
                    t.defaultPrevented || (t.preventDefault(),
                        this.isToggled() === b(or, this) && this.toggle())
                }
            }, {
                name: "beforeshow",
                self: !0,
                ...
                handler: function () {
                    ...
                    li(window) - li(document) && this.overlay && Ve(document.body, "overflowY", "scroll"),
                        ...
                        this.bgClose && Gt(this.$el, "hide", Yt(document, pt, function (t) {
                            var r = t.target;
                        ...
                        this.escClose && Gt(this.$el, "hide", Yt(document, "keydown", function (t) {
                            27 === t.keyCode && K(or) === o && (t.preventDefault(),
                                o.hide())
                        }), {
                            self: !0
                        })
    ...
    var hr = {
        install: function (t) {
            ...
            a.dialog = function (t, e) {
                var i = a('<div class="jl-modal"> <div class="jl-modal-dialog">' + t + "</div> </div>", e);
                return i.show(),
                    Yt(i.$el, "hidden", function () {
                        return se.resolve().then(function () {
                            return i.$destroy(!0)
                        })
                    }, {
                ...
                a.alert = function (i, t) {
                    return e(function (t) {
                        var e = t.labels;
                        return '<div class="jl-modal-body">' + (D(i) ? i : ve(i)) + '</div> <div class="jl-modal-footer jl-text-right"> <button class="jl-button jl-button-primary jl-modal-close" autofocus>' + e.ok + "</button> </div>"
                    }, t, function (t) {
                        return t.resolve()
                    })
                }
                ...
                a.confirm = function (i, t) {
                    return e(function (t) {
                        var e = t.labels;
                        return '<form> <div class="jl-modal-body">' + (D(i) ? i : ve(i)) + '</div> <div class="jl-modal-footer jl-text-right"> <button class="jl-button jl-button-default jl-modal-close" type="button">' + e.cancel + '</button> <button class="jl-button jl-button-primary" autofocus>' + e.ok + "</button> </div> </form>"
                    }, t, function (t) {
                        return t.reject()
                    })
                }
                ...
                a.prompt = function (i, n, t) {
                    return e(function (t) {
                        var e = t.labels;
                        return '<form class="jl-form-stacked"> <div class="jl-modal-body"> <label>' + (D(i) ? i : ve(i)) + '</label> <input class="jl-input" value="' + (n || "") + '" autofocus> </div> <div class="jl-modal-footer jl-text-right"> <button class="jl-button jl-button-default jl-modal-close" type="button">' + e.cancel + '</button> <button class="jl-button jl-button-primary">' + e.ok + "</button> </div> </form>"
                    }, t, function (t) {
        ...
        mixins: [sr],
        data: {
            clsPage: "jl-modal-page",
            selPanel: ".jl-modal-dialog",
            selClose: ".jl-modal-close, .jl-modal-close-default, .jl-modal-close-outside, .jl-modal-close-full"
        },
        events: [{
            name: "show",
            self: !0,
            handler: function () {
                Oe(this.panel, "jl-margin-auto-vertical") ? ze(this.$el, "jl-flex") : Ve(this.$el, "display", "block"),
                    ci(this.$el)
            }
        }, {
            name: "hidden",
    ...
    var ur = {
        ...
        , cr = {
            ...
            data: {
                dropdown: ".jl-navbar-nav > li",
                align: ct ? "right" : "left",
                clsDrop: "jl-navbar-dropdown",
                mode: void 0,
                offset: void 0,
                delayShow: void 0,
                delayHide: void 0,
                ...
                duration: 200,
                forceHeight: !0,
                selMinHeight: ".jl-navbar-nav > li > a, .jl-navbar-item, .jl-navbar-toggle"
            },
            computed: {
                boundary: function (t, e) {
                    var i = t.boundary
                ...
                dropbar: {
                    get: function (t) {
                        var e = t.dropbar;
                        return e ? (e = this._dropbar || xt(e, this.$el) || _e("+ .jl-navbar-dropbar", this.$el)) || (this._dropbar = _e("<div></div>")) : null
                    },
                    watch: function (t) {
                        ze(t, "jl-navbar-dropbar"),
                            He(t, "jl-navbar-dropbar-slide", "slide" === this.dropbarMode)
                    },
                    immediate: !0
                },
                dropdowns: {
        ...
        , lr = {
            ...
            data: {
                ...
                flip: !1,
                overlay: !1,
                clsPage: "jl-offcanvas-page",
                clsContainer: "jl-offcanvas-container",
                selPanel: ".jl-offcanvas-bar",
                clsFlip: "jl-offcanvas-flip",
                clsContainerAnimation: "jl-offcanvas-container-animation",
                clsSidebarAnimation: "jl-offcanvas-bar-animation",
                clsMode: "jl-offcanvas",
                clsOverlay: "jl-offcanvas-overlay",
                selClose: ".jl-offcanvas-close",
                container: !1
            },
            computed: {
                clsFlip: function (t) {
    ...
    var fr = {
        ...
        data: {
            selContainer: ".jl-modal",
            selContent: ".jl-modal-dialog"
        },
        computed: {
        ...
        , pr = {
            props: ["width", "height"],
            connected: function () {
                ze(this.$el, "jl-responsive-width")
            },
            update: {
                read: function () {
            ...
            methods: {
                scrollTo: function (t) {
                    ...
                    t = t && _e(t) || document.body,
                        Kt(this.$el, "beforescroll", [this, t]) && Oi(t, {
                            offset: this.offset
                        }).then(function () {
        ...
        , gr = {
            ...
            data: function () {
                return {
                    ...
                    repeat: !1,
                    delay: 0,
                    inViewClass: "jl-scrollspy-inview"
                }
            },
            computed: {
                elements: {
            ...
            update: [{
                read: function (t) {
                    ...
                    t.update && this.elements.forEach(function (t) {
                        ...
                        (e = e || {
                            cls: ht(t, "jl-scrollspy-class") || i.cls
        ...
        , wr = {
            ...
            data: {
                ...
                clsActive: "jl-active",
                clsInactive: "",
                clsFixed: "jl-sticky-fixed",
                clsBelow: "jl-sticky-below",
                selTarget: "",
                widthElement: !1,
                showOnUp: !1,
                targetOffset: !1
            ...
            computed: {
                ...
                isActive: {
                    ...
                    set: function (t) {
                        t && !this.isActive ? (Pe(this.selTarget, this.clsInactive, this.clsActive),
                            Kt(this.$el, "active")) : t || Oe(this.selTarget, this.clsInactive) || (Pe(this.selTarget, this.clsActive, this.clsInactive),
                                Kt(this.$el, "inactive"))
                    }
                }
            },
            connected: function () {
                this.placeholder = _e("+ .jl-sticky-placeholder", this.$el) || _e('<div class="jl-sticky-placeholder"></div>'),
                    this.isFixed = !1,
                    this.isActive = !1
            },
            disconnected: function () {
            ...
            update: [{
                ...
                read: function (t) {
                    var e = t.scroll;
                    return void 0 === e && (e = 0),
                        this.width = (Ft(this.widthElement) ? this.widthElement : this.$el).offsetWidth,
    ...
    function br(t, e) {
        var i = e.$props
            ...
            , o = i[t];
        if (o)
            return P(o) && D(o) && o.match(/^-?\d/) ? r + wi(o) : si(!0 === o ? n.parentNode : xt(o, n)).bottom
    }
    var xr = {
        mixins: [un],
        args: "connect",
        ...
        data: {
            ...
            swiping: !0,
            cls: "jl-active",
            clsContainer: "jl-switcher",
            attrItem: "jl-switcher-item",
            queued: !0
        },
        computed: {
            connects: {
            ...
            toggles: {
                get: function (t, e) {
                    return Me(t.toggle, e).filter(function (t) {
                        return !Nt(t, ".jl-disabled *, .jl-disabled, [disabled]")
                    })
                },
                watch: function (t) {
                    var e = this.index();
        ...
        , yr = {
            ...
            data: {
                media: 960,
                attrItem: "jl-tab-item"
            },
            connected: function () {
                var t = Oe(this.$el, "jl-tab-left") ? "jl-tab-left" : !!Oe(this.$el, "jl-tab-right") && "jl-tab-right";
        ...
        , kr = {
            ...
            events: [{
                ...
                handler: function (t) {
                    var e;
                    (Dt(t.target, 'a[href="#"], a[href=""]') || (e = Dt(t.target, "a[href]")) && (this.cls && !Oe(this.target, this.cls.split(" ")[0]) || !Ft(this.target) || e.hash && Nt(this.target, e.hash))) && t.preventDefault(),
                        this.toggle()
                }
            }],
            update: {
    ...
    var Sr, Tr = "jl-animation-target", Er = {
        props: {
            animation: Number
        },
        data: {
        ...
        methods: {
            ...
            setState: function (u, t) {
                ...
                void 0 === t && (t = !0),
                    ...
                    Kt(this.$el, "beforeFilter", [this, u]);
                var l = this.children;
                this.toggles.forEach(function (t) {
    ...
    function Pr(t, e) {
        return void 0 === t && (t = 0),
            void 0 === e && (e = "%"),
            t += t ? e : "",
            ut ? "translateX(" + t + ")" : "translate3d(" + t + ", 0, 0)"
    }
    function Or(t) {
            ...
            update: {
                write: function () {
                    ...
                    this.nav && this.length !== this.nav.children.length && ve(this.nav, this.slides.map(function (t, e) {
                        ...
                        He(Me(this.selNavItem, this.$el).concat(this.nav), "jl-hidden", !this.maxIndex),
                        this.updateNav()
                },
                events: ["resize"]
            },
                ...
                updateNav: function () {
                    ...
                    this.navItems.forEach(function (t) {
                        ...
                        He(t, i.clsActive, F(e) === n),
                            He(t, "jl-invisible", i.finite && ("previous" === e && 0 === n || "next" === e && n >= i.maxIndex))
                    })
                }
            }
        }],
                ...
                if (void 0 === e && (e = !1),
                    ...
                    if (n[e ? "unshift" : "push"](t),
                        ...
                        if (a !== u) {
                            var c, l;
                            if (this.dir = (l = s,
                                "next" !== (c = t) && ("previous" === c || c < l) ? -1 : 1),
                                this.prevIndex = s,
                                this.index = h,
                                a && Kt(a, "beforeitemhide", [this]),
                                !Kt(u, "beforeitemshow", [this, a]))
    ...
    var Wr = {
        ...
        data: {
            animation: "slide",
            clsActivated: "jl-transition-active",
            Animations: Dr,
        ...
        , Vr = {
            ...
            computed: {
                caption: function (t, e) {
                    t.selCaption;
                    return _e(".jl-lightbox-caption", e)
                }
            },
            events: [{
                name: mt + " " + pt + " keydown",
                ...
                handler: function (t, r) {
                    ...
                    var i = r.poster
                        , a = r.attrs;
                    if (void 0 === a && (a = {}),
                        this.setItem(r, "<span jl-spinner></span>"),
                        n) {
                        var h, u = {
                            frameborder: "0",
                            allow: "autoplay",
                        ...
                        if ("image" === e || n.match(/\.(jpe?g|png|gif|svg|webp)($|\?)/i))
                            de(n, a.srcset, a.size).then(function (t) {
                                var e = t.width
                                    , i = t.height;
                            ...
                            "iframe" === e || n.match(/\.(html|php)($|\?)/i) ? this.setItem(r, Rr("iframe", G({
                                src: n,
                                frameborder: "0",
                                allowfullscreen: "",
                                class: "jl-lightbox-iframe"
            ...
            methods: {
                ...
                setError: function (t) {
                    this.setItem(t, '<span jl-icon="icon: bolt; ratio: 2"></span>')
                },
                showControls: function () {
                    clearTimeout(this.controlsTimer),
                        this.controlsTimer = setTimeout(this.hideControls, this.delayControls),
                        ze(this.$el, "jl-active", "jl-transition-active")
                },
                hideControls: function () {
                    De(this.$el, "jl-active", "jl-transition-active")
                }
            }
        };
    function Rr(t, e) {
    ...
    var qr, Ur = {
        ...
        events: [{
            name: "click",
            delegate: function () {
                return this.toggle + ":not(.jl-disabled)"
            },
            handler: function (t) {
                t.preventDefault(),
                    this.show(t.current)
    ...
    var Xr = {
        ...
        data: {
            ...
            group: null,
            pos: "top-center",
            clsContainer: "jl-notification",
            clsClose: "jl-notification-close",
            clsMsg: "jl-notification-message"
        },
        install: function (r) {
        ...
        created: function () {
            ...
            this.$mount(we(t, '<div class="' + this.clsMsg + (this.status ? " " + this.clsMsg + "-" + this.status : "") + '"> <a href class="' + this.clsClose + '" data-jl-close></a> <div>' + this.message + "</div> </div>"))
        },
        connected: function () {
    ...
    function to(t, e, i) {
        var n, r = no(t, e);
        return i ? r - (n = t,
            si(e).width / 2 - si(n).width / 2) : Math.min(r, eo(e))
    }
    function eo(t) {
        ...
        computed: {
            ...
            maxIndex: function () {
                ...
                for (var t = eo(this.list), e = this.length; e--;)
                    if (no(this.list.children[e], this.list) < t)
            ...
            sets: function (t) {
                ...
                return !O(e = e && this.slides.reduce(function (t, e, i) {
                    var n = si(e).width;
                    if (a < u + n && (!o.center && i > o.maxIndex && (i = o.maxIndex),
                        !b(t, i))) {
                        var r = o.slides[i + 1];
                        o.center && r && n < h - si(r).width / 2 ? h -= n : (h = s,
                            t.push(i),
                            a = u + s + (o.center ? n / 2 : 0))
                    }
                    return u += n,
                        t
                }, [])) && e
        ...
        update: {
            write: function () {
                ...
                Me("[" + this.attrItem + "],[data-" + this.attrItem + "]", this.$el).forEach(function (t) {
                    var e = ht(t, i.attrItem);
                    i.maxIndex && He(t, "jl-hidden", P(e) && (i.sets && !b(i.sets, j(e)) || e > i.maxIndex))
                }),
            ...
            events: [{
                ...
                handler: function (t) {
                    ...
                    Ze.cancel(this.$el),
                        ...
                        Ze.start(this.$el, this.getCss(ho(e) ? .5 : 0 < s ? 1 : 0), r, o).catch(et)
                }
            }, {
    ...
    var co, lo, fo = G({}, Dr, {
        ...
        data: {
            ...
            minHeight: !1,
            maxHeight: !1,
            selList: ".jl-slideshow-items",
            attrItem: "jl-slideshow-item",
            selNav: ".jl-slideshow-nav",
            Animations: fo
        },
        update: {
            read: function () {
        ...
        data: {
            group: !1,
            threshold: 5,
            clsItem: "jl-sortable-item",
            clsPlaceholder: "jl-sortable-placeholder",
            clsDrag: "jl-sortable-drag",
            clsDragState: "jl-drag",
            clsBase: "jl-sortable",
            clsNoDrag: "jl-sortable-nodrag",
            clsEmpty: "jl-sortable-empty",
            clsCustom: "",
            handle: !1,
            pos: {}
        },
        ...
        methods: {
            init: function (t) {
                ...
                !r || n || 0 < i || Wt(e) || Rt(e, "." + this.clsNoDrag) || this.handle && !Rt(e, this.handle) || (t.preventDefault(),
                    this.touched = [this],
                    this.placeholder = r,
                    this.origin = G({
                        target: e,
            ...
            insert: function (i, n) {
                ...
                function t() {
                    var t, e;
                    n ? (!Rt(i, r.target) || (e = n,
                        (t = i).parentNode === e.parentNode && pe(t) > pe(e)) ? be : xe)(n, i) : we(r.target, i)
                }
    ...
    var go = []
        , vo = {
            ...
            data: {
                ...
                title: "",
                delay: 0,
                animation: ["jl-animation-scale-up"],
                duration: 100,
                cls: "jl-active",
                clsPos: "jl-tooltip"
            },
        ...
        , wo = {
            ...
            events: {
                change: function (t) {
                    Nt(t.target, 'input[type="file"]') && (t.preventDefault(),
        ...
        qi.use(function (r) {
            fe(function () {
                ...
                Yt(document, "animationstart", function (t) {
                    var e = t.target;
                    (Ve(e, "animationName") || "").match(/^jl-.*(left|right)/) && (n++,
